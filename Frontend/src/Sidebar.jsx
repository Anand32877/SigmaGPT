    ...
    const deleteThread = async (threadId) => {
        try {  
            ...
            if (currThreadId === threadId) {
                createNewChat();  // If the deleted thread is the current one, create a new chat
            }
    ...
    return (
        <section className="sidebar">
            ...
            <button onClick={createNewChat}>   
                <img src="src/assets/blacklogo.png" alt="gpt image" className="logo"></img>
                    ...
                    allThreads?.map((thread, idx)=>(
                        ...
                        onClick={(e)=>changeThread(thread.threadId)}>
                            ...
                            <i className="fa-solid fa-trash"
                                onClick={(e)=>{
                                    e.stopPropagation();  //stop the click event from bubbling up to the li(event bubbling)
